Reference to this example: https://openlayers.org/en/latest/examples/xyz.html
I set up pointerDown and pointerUp events to detect double clicks.

In the URL http://localhost:5173/?miss=1, you can see that the double-click event is not triggered.
